...
class DecimalKeypadWithMinus: UIView {
    ...
    var minusButton: UIButton = {
        ...
        button.accessibilityTraits = [.keyboardKey]
        button.accessibilityLabel = "Minus"
...
extension DecimalKeypadWithMinus {
...
private extension DecimalKeypadWithMinus {
    func configure() {
    ...
    func addButtons() {
        ...
        subStackView.addArrangedSubview(minusButton)
